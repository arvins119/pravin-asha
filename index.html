																					...
																					<div class="swiper-wrapper">
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/23-1.jpg);
                                                  "></div>
																						</div>
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/24.jpg);
                                                  "></div>
																						</div>
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/14.jpg);
                                                  "></div>
																						</div>
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/1-4.jpg);
                                                  "></div>
																						</div>
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/37-1.jpg);
                                                  "></div>
																						</div>
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/21.jpg);
                                                  "></div>
																						</div>
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/19.jpg);
                                                  "></div>
																						</div>
																						<div class="swiper-slide">
																							<div class="elementor-carousel-image"
																								style="
                                                    background-image: url(./assets/uploads/2019/12/29.jpg);
                                                  "></div>
																						</div>
																					</div>
